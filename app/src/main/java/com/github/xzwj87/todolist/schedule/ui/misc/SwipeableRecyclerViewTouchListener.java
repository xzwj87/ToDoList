...
package com.github.xzwj87.todolist.schedule.ui.misc;
...
public class SwipeableRecyclerViewTouchListener implements RecyclerView.OnItemTouchListener {
    private static final String LOG_TAG = SwipeableRecyclerViewTouchListener.class.getSimpleName();
    ...
    private long ANIMATION_WAIT = 1000;
